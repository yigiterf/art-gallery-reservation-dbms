...
const EventDetail: React.FC = () => {
  ...
  const isOwner = eventData && user.sanatci_id && eventData.sanatci_id === user.sanatci_id;
                  ...
                  <div key={review.id} className="bg-white rounded-2xl border border-slate-100 p-6 hover:shadow-md transition-shadow">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {/* Organizatör/Sahip Yanıtı (özel stil) */}
                        {review.sahip_yaniti && (
                          <div className="mt-3 pl-4 border-l-4 border-indigo-500 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-r-xl p-4">
                            <p className="text-xs font-bold text-indigo-600 mb-1 flex items-center gap-1">
                              <CheckCircle size={11} className="fill-indigo-600 text-white" /> Organizatör Yanıtı
                        ...
                        {replyingTo === review.id && (
                          <div className="mt-3 flex gap-2">
                            <input
                              ...
                              placeholder="Organizatör olarak yanıtınızı yazın..."
                            ...
                            <button onClick={() => setReplyingTo(null)} className="px-3 py-2 text-slate-400 hover:text-slate-600 text-xs">İptal</button>
                          </div>
                        )}
                      </div>
                    </div>
